...
class FCN8s(nn.Module):
    ...
    def __init__(self, ch_in=3, ch_out=21):
        ...
        # conv1
        self.conv1_1 = nn.Conv2d(ch_in, 64, 3, padding=100)
        ...
        self.score_fr = nn.Conv2d(4096, ch_out, 1)
        self.score_pool3 = nn.Conv2d(256, ch_out, 1)
        self.score_pool4 = nn.Conv2d(512, ch_out, 1)

        self.upscore2 = nn.ConvTranspose2d(
            ch_out, ch_out, 4, stride=2, bias=False)
        self.upscore8 = nn.ConvTranspose2d(
            ch_out, ch_out, 16, stride=8, bias=False)
...
def create_model(config):
    ...
    return FCN8s(ch_in=ch_in, ch_out=ch_out)