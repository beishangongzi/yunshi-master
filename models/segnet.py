...
class SegNet(nn.Module):
    def __init__(self, ch_in=3, ch_out=7):
        super(SegNet, self).__init__()

        batchNorm_momentum = 0.1

        self.conv11 = nn.Conv2d(ch_in, 64, kernel_size=3, padding=1)
        ...
        self.conv11d = nn.Conv2d(64, ch_out, kernel_size=3, padding=1)
...
def create_model(config):
    ...
    return SegNet(ch_in=ch_in, ch_out=ch_out)